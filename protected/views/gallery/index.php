...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">相册信息</div>
  <!-- Table -->

  <button type=button  class="btn btn-success"onclick="location.href =('/gallery/add')"> <span class="glyphicon glyphicon-plus"></span></button>
 </button>
